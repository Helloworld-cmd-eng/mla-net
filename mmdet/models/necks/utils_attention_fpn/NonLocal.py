...
class NonLocal(nn.Module):
    def __init__(self, dim, depth, heads, mlp_dim=64, dim_head = 32, dropout = 0.25, emb_dropout = 0.25):
    ...
    def forward(self, feat_x):
        ...
        '''
        n_imgbatch,embed_dim,hight,width=feat_x.shape
        x=feat_x.flatten(2,3).permute(0,2,1)
...
if __name__=='__main__':
    v = NonLocal(dim=64, heads=4, depth=1, mlp_dim=64, dim_head=32, dropout=0.5)

    img = torch.randn(1,64,5,5)
